...
public class Usuario {
    ...
    @NotBlank @Column(nullable = false, unique = true, length = 50) private String usuario;
    @NotBlank @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) @Column(name = "contraseña", nullable = false, length = 255) private String contrasena;
