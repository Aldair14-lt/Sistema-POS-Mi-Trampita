...
public class Cliente {
    ...
    @NotBlank @Size(max = 20) @Column(name = "numero_documento", nullable = false, length = 20) private String numeroDocumento;
    @NotBlank @Size(max = 150) @Column(name = "nombres_razon_social", nullable = false, length = 150) private String nombresRazonSocial;
    @Size(max = 255) @Column(length = 255) private String direccion;
